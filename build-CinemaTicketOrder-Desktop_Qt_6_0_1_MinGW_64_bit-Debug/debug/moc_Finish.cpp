/****************************************************************************
** Meta object code from reading C++ file 'Finish.h'
**
...
#include <memory>
#include "../../CinemaTicketOrder/Finish.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Finish.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Finish_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Finish_t qt_meta_stringdata_Finish = {
    {
QT_MOC_LITERAL(0, 6) // "Finish"
...
const QMetaObject Finish::staticMetaObject = { {
    ...
    qt_meta_stringdata_Finish.offsetsAndSize,
    qt_meta_data_Finish,
    qt_static_metacall,
    nullptr,
    nullptr,
